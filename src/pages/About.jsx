            ...
            <div className="row flex justify-between font-medium">
                ...
                <div>
                    ...
                    <div className='flex flex-col gap-[15px] mt-[22px]'>
                        {
                            items.map((item,i)=>(
                                <Link key={i} className='Footer text-[20px] font-medium hover:text-[#FC8934] duration-400 cursor-pointer' to={item.path}>{item.Name}</Link>
                            ))
                        }
                    </div>
                ...
                <div>
                    ...
                    <div className='flex flex-col gap-[15px] mt-[22px]'>
                        {
                            help.map((item,i)=>(
                                <Link key={i} className='text-[20px] font-medium' to={item.path}>{item.Name}</Link>
                            ))
                        }
                    </div>
                ...
                <div>
                    <h2 className='text-[22px] text-[#000]'>DBID ID : 437361334</h2>
                </div>
